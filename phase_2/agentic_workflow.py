...
with open(os.path.join(os.path.dirname(__file__), "Product-Spec-Email-Router.txt"), "r") as f:
    product_spec = f.read()
...
knowledge_program_manager = (
    "Define Email Router product features using the product specification below.\n\n"
    + product_spec
)
...
knowledge_dev_engineer = (
    "Define engineering tasks for implementing the Email Router specification below.\n\n"
    + product_spec
)
...
def product_manager_support_function(query):
    """Route a query to the Product Manager knowledge agent and evaluate the response."""
...
def program_manager_support_function(query):
    """Route a query to the Program Manager knowledge agent and evaluate the response."""
...
def development_engineer_support_function(query):
    """Route a query to the Development Engineer knowledge agent and evaluate the response."""
...
routing_agent.agents = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Does not define individual user stories or engineering tasks."
        ),
    ...
    },
    {
        ...
        "description": (
            "Responsible for defining engineering development tasks required to implement user stories. "
...
workflow_prompt = (
    ...
    "Generate user stories, product features, and engineering tasks."
)
# ****
